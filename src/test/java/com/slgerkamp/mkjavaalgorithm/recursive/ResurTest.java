...
public class ResurTest {
	...
	@RunWith(Theories.class)
	public static class 再帰を使わない再帰アルゴリズム_1{
		@DataPoints
		public static Fixture[] FIXTURES = {
			new Fixture(1, Arrays.asList(new Integer [] {1})),
			new Fixture(2, Arrays.asList(new Integer [] {1,2})),
		...
		@Theory
		public void 再帰テスト(Fixture f){
			assertThat(ResurNotResur.resur(f.num, new ArrayList<Integer>()), is(f.expected));
		}
		
	}

	@RunWith(Theories.class)
	public static class 再帰を使わない再帰アルゴリズム_2{
		@DataPoints
		public static Fixture[] FIXTURES = {
			new Fixture(1, Arrays.asList(new Integer [] {1})),
			new Fixture(2, Arrays.asList(new Integer [] {2,1})),
		...
		public void 再帰テスト(Fixture f){
			System.out.println();
			assertThat(ResurNotResur.resur_2(f.num, new ArrayList<Integer>()), is(f.expected));
		}
